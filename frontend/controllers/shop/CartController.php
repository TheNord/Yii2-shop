...
class CartController extends Controller
{
    ...
    public function actionAdd($id)
    {
        ...
        // добавление товара без модификации
        // переадрессуем сразу же, так как не нужно пользователю ничего выбирать
        ...
        // если у товара есть модификации добавляем форму и рендерим страницу
        // пользователю будет нужно выбрать модификацию и количество
        $this->layout = 'blank';
        $form = new AddToCartForm($product);
        // добавляем товар в корзину при заполнении всех данных
