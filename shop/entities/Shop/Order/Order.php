...
class Order extends ActiveRecord
{
    ...
    {
        // добавляем в историю статусов информацию о создании
        $this->statuses[] = new Status($value, time());
        // меняем текущий статус заказа
    ...
    {
        // декодируем json поле со статусами и циклом проходим по ним перегоняя в объект Status
        ...
        // перегоняем данные из нескольких полей в объект customerData и deliveryData
    ...
    {
        // конвертируем всю историю статусов в json поле перед записью в базу
