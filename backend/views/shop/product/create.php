...
<div class="product-create">
    ...
    <div class="box box-default">
        ...
        <div class="box-body">
            ...
            <!-- Если из формы пришли варианты для выпадающего списка - выводим в выпадающем списке -->
                <?php if ($variants = $value->variantsList()): ?>
                    <?= $form->field($value, '[' . $i . ']value')->dropDownList($variants, ['prompt' => '']) ?>
                    <!-- Если вариантов нет то выводим текстовым полем -->
                <?php else: ?>
    ...
    <div class="box box-default">
        ...
        <div class="box-body">
            <!-- Использьуем виджет от Картика для красивой загрузки фотографий -->
