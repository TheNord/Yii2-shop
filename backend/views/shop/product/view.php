...
<div class="user-view">
                ...
                <div class="box-body">
                    <?= DetailView::widget([
                        ...
                        'attributes' => [
                            ...
                            // по полю brand_id получаем название бренда ($product->brand->name)
                            [
                                'attribute' => 'brand_id',
        ...
        <div class="col-md-6">
            ...
            <div class="box box-default">
                ...
                <div class="box-body">
                    ...
                    <?= DetailView::widget([
                        'model' => $product,
                        // передаем массив атрибутов и через array map выводим имя каждого и его значение
    ...
    <div class="box" id="modifications">
        ...
        <div class="box-body">
            <p>
                <!-- Выводим модификации в виде грида с возможностью удаления и редактирования -->
            ...
            <?= GridView::widget([
                ...
                'columns' => [
                    ...
                    [
                        'attribute' => 'price',
                        // у цены удаляем лишние значения после запятой
    ...
    <div class="box" id="photos">
        ...
        <div class="box-body">
            ...
            <div class="row">
                <!-- Проходим циклом по всем фотографиям -->
                <?php foreach ($product->photos as $photo): ?>
                    <div class="col-md-2 col-xs-3" style="text-align: center">
                        <!-- Добавляем к фотографии кнопки ее перемещения и удаления -->
                        <div class="btn-group">
            ...
            <!-- Добавляем виджет от Картика для загрузки фотографий -->
